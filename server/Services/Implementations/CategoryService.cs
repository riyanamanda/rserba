...
{
    public async Task<DataResponse> GetAll(ICategoryRepository categoryRepository)
    {
    ...
    public Task Delete(ICategoryRepository categoryRepository, string slug)
    {
        throw new NotImplementedException();
    }

    public Task FindBySlug(ICategoryRepository categoryRepository, string slug)
    {
        throw new NotImplementedException();
    }

    public Task Update(ICategoryRepository categoryRepository, string slug, UpdateCategoryDto request)
    {
        throw new NotImplementedException();
    }
}